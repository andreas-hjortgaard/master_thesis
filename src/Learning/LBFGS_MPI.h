...
#ifndef _LBFGS_MPI_H_
#define _LBFGS_MPI_H_
...
class LBFGS_MPI : public GradientDescent {
  ...
  protected:
   ...
   static lbfgsfloatval_t _evaluate(
    ...
    {
      return reinterpret_cast<LBFGS_MPI*>(instance)->evaluate(x, g, n, step);
    }
    ...
    {
      return reinterpret_cast<LBFGS_MPI*>(instance)->progress(x, g, fx, xnorm, gnorm, step, n, k, ls);
    }
  ...
  public:
    ...
    // constructor
    LBFGS_MPI(ObjectiveFunction *obj, Gradient *grad);
    ~LBFGS_MPI();
