...
void usage() {
  cout << "modelSelectionPseudo [rootpath] [object] [stepSize] [lambda] [kickstart] [weightpath]" << endl;
  cout << "Options:" << endl;
...
int main(int argc, char **argv) {
  ...
  ostringstream os;
  os << rootPath << "/results/pseudolikelihood/" << object << "_" << stepSize << "_" << lambda << "_info.txt";
  string infoFile = os.str();
  
  os.clear();
  os.str("");
  os << rootPath << "/results/pseudolikelihood/" << object << "_" << stepSize << "_" << lambda << "_weights.txt";
  string weightFile = os.str();
  
  os.clear();
  os.str("");
  os << rootPath << "/results/pseudolikelihood/" << object << "_" << stepSize << "_" << lambda << "_tempWeights.txt";
  string tempWeightFile = os.str();
  
  // recall overlap figures
  os.clear();
  os.str("");
  os << rootPath << "/results/pseudolikelihood/" << object << "_" << stepSize << "_" << lambda << "_recallOverlapTrain";
  string lossTrain = os.str();
  
  os.clear();
  os.str("");
  os << rootPath << "/results/pseudolikelihood/" << object << "_" << stepSize << "_" << lambda << "_recallOverlapVal";
  ...
  infostream << "Objective function      : PseudoLikelihood\n";
  infostream << "Gradient                : PseudoLikelihoodGradient\n";
